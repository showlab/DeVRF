...
fine_train = dict(
    N_iters=24000,                              # number of optimization steps
    ...
    pg_motionscale=[8000, 16000, 20000, 22000], # checkpoints for motion progressive scaling   
...
fine_model_and_render = dict(
    ...
    num_voxels_motion=128**3,                   # expected number of motion voxel
    ...
    timesteps=40,                               # number of timesteps soccer use 4 views and reduce last step as test.
